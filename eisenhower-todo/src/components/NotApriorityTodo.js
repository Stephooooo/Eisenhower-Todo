...
function NotApriorityTodo({todos, completeTodo, removeTodo, updateTodo}) {
    ...
    if (edit.id) {
        return <NotApriorityForm edit={edit} onSubmit={submitUpdate} />;
    }
...
export default NotApriorityTodo
