...
const Button = ({buttonStyle, onClick, text, type}) => {
  ...
  const blueButtonClassName = 'bg-transparent hover:bg-todo-blue text-todo-blue font-bold hover:text-todo-white py-2 w-200px text-sm p-1 h-38px px-4 border border-todo-blue hover:border-transparent rounded-full '
